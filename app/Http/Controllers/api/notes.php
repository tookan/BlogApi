...
class notes extends Controller
{
    ...
    protected function searchService($searchTerm, $offset = 1)
    {
    ...
    protected function noteCreate(Request $request)
    {
        ...
        if ($user['status'] !== 'admin') $input['user_id'] = $user['id'];
    ...
    {
        $notes = Note::select('notes.id as id', 'title', 'users.name as username', 'small_img as img')
